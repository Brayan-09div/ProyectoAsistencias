            ...
            <q-img class="absolute-top"
              ...
              <div class="absolute-bottom bg-transparent">
                <q-avatar size="70px" class="q-mb-sm">
                  <q-avatar size="70px" class="q-mb-sm">
                    <img :src="useUsuarios.usuarios.usuario.avatar" alt="User avatar">
                  </q-avatar>
                </q-avatar>
...
const avatarUrl = computed(() => {
  const avatar = useUsuarios.usuarios.usuario.avatar;
  return avatar ? `https://tu-dominio.com/${avatar}` : '/path/to/default/avatar.jpg';
});
